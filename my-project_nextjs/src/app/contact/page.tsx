...
export default function ContactPage() {
  ...
  if (success) {
    return (
      <main className="min-h-screen bg-linear-to-br from-emerald-50 to-emerald-100 dark:from-slate-950 dark:to-slate-900">
    ...
    <main className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      ...
      <section className="mx-auto max-w-2xl px-6 py-20">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-4 bg-linear-to-r from-slate-900 to-slate-700 dark:from-slate-100 dark:to-slate-300 bg-clip-text text-transparent">
            Lass uns reden!
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-linear-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 
